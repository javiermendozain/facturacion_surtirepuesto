 ...
 */
    ...
    class public_registrar_compra_public_detalle_factura_compraPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $field = new StringField('garantia');
            $this->dataset->AddField($field, false);
            ...
            WHERE 
              caracteristicas.idcaracter = productos.idcaracter)', new StringField('idproducto'), new StringField('name', 'idproducto_name', 'idproducto_name_product_compra'), 'idproducto_name_product_compra');
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'garantia', 'garantia', $this->RenderText('Garantia'))
            );
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('garantia');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for garantia field
            //
            $column = new TextViewColumn('garantia', 'garantia', 'Garantia', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for garantia field
            //
            $editor = new HtmlWysiwygEditor('garantia_edit');
            $editColumn = new CustomEditColumn('Garantia', 'garantia', $editor, $this->dataset);
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_idproducto_name_search', 'idproducto', 'name', null, 20);
            ...
            $lookupDataset->setOrderByField('name', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_idproducto_name_search', 'idproducto', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_idproducto_name_search', 'idproducto', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class public_registrar_compraPage extends Page
    {
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'idfactura_compra', 'idfactura_compra', $this->RenderText('ID ')),
                ...
                new FilterColumn($this->dataset, 'fecha_de_pago', 'fecha_de_pago', $this->RenderText('Fecha Recibido')),
                new FilterColumn($this->dataset, 'nota', 'nota', $this->RenderText('Nota'))
            );
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('nota_edit');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('idfactura_compra', 'idfactura_compra', 'ID ', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            ...
            //
            $column = new DateTimeViewColumn('fecha_de_pago', 'fecha_de_pago', 'Fecha Recibido', $this->dataset);
            $column->SetDateTimeFormat('Y-m-d');
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            ...
            //
            // View column for nota field
            //
            $column = new TextViewColumn('nota', 'nota', 'Nota', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new CustomEditColumn('Fecha Recibido', 'fecha_de_pago', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for nota field
            //
            $editor = new TextEdit('nota_edit');
            $editColumn = new CustomEditColumn('Nota', 'nota', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('nombre_comercial', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_id_proveedor_nombre_comercial_search', 'nit_cc', 'nombre_comercial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            $lookupDataset = new TableDataset(
                PgConnectionFactory::getInstance(),
                GetConnectionOptions(),
            ...
            $lookupDataset->setOrderByField('nombre_comercial', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_id_proveedor_nombre_comercial_search', 'nit_cc', 'nombre_comercial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nombre_comercial', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_id_proveedor_nombre_comercial_search', 'nit_cc', 'nombre_comercial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
        ...
        { 
            ...
            $handled=true;
             ...
             if($fieldName=='fecha_de_pago'){
                            if(!empty($rowData['fecha_de_pago'])){
            
                            $fechactual= new DateTime(date('Y-m-d'));
                        $fecha_compra= new DateTime($rowData['fecha_de_pago']);
                        //hora registrada
                        $fecha_recibido= new DateTime($rowData['fecha_de_compra']);
                        //calculo de diferencias
                        $diferencia_conversion=$fecha_compra->diff($fecha_recibido);
                       // $tiempo=+($diferencia_conversion->m);
                       // $tiempo=($diferencia_conversion->y*12)+($diferencia_conversion->m)+$diferencia_conversion->d;
                        
                         $customText=($diferencia_conversion->y*12).'  A&ntilde;os, '.($diferencia_conversion->m).' Meses, '.($diferencia_conversion->d).' Dias';
                        $handled=true;
                            }else{
                              $fechactual= new DateTime(date('Y-m-d'));
                                           $fecha_compra= new DateTime($rowData['fecha_de_compra']);
                                         $diferencia_conversion=$fecha_compra->diff($fechactual);
                                         
                                         
                                        $customText='No Recibido: '.($diferencia_conversion->y*12).'  A&ntilde;os, '.($diferencia_conversion->m).' Meses, '.($diferencia_conversion->d).' Dias';
                                    $handled=true;
