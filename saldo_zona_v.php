 ...
 */
    ...
    class public_saldo_zona_vPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new NumberViewColumn('idzona', 'idzona', 'Idzona', $this->dataset);
            ...
            //
            $column = new NumberViewColumn('saldo', 'saldo', 'Saldo', $this->dataset);
            $column->SetOrderable(false);
    ...
    try
    {
        $Page = new public_saldo_zona_vPage("public_saldo_zona_v", "saldo_zona_v.php", GetCurrentUserGrantForDataSource("public.saldo_zona_v"), 'UTF-8');
        $Page->SetTitle('Saldo Zona V');
        $Page->SetMenuLabel('Saldo Zona V');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.saldo_zona_v"));
