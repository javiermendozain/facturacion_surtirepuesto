 ...
 */
    ...
    class public_detalle_factura_ventaPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddLookupField('idventa', 'public.facturar_ventas', new IntegerField('idventa', null, null, true), new StringField('n_factura', 'idventa_n_factura', 'idventa_n_factura_public_facturar_ventas'), 'idventa_n_factura_public_facturar_ventas');
        }
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('n_factura', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_idventa_n_factura_search', 'idventa', 'n_factura', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
