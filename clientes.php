    ...
    class public_clientesPage extends Page
    {
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'cupo_tope', 'cupo_tope', $this->RenderText('Tope Crédito')),
                new FilterColumn($this->dataset, 'dia_limites_facturas', 'dia_limites_facturas', $this->RenderText('Día Limites de Pagos'))
            );
        }
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new NumberViewColumn('cupo_tope', 'cupo_tope', 'Tope Crédito', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(2);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('.');
            ...
            //
            $column = new TextViewColumn('dia_limites_facturas', 'dia_limites_facturas', 'Día Limites de Pagos', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new CustomEditColumn('Tope Crédito', 'cupo_tope', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            ...
            $editor->SetMaxLength(10);
            $editColumn = new CustomEditColumn('Día Limites de Pagos', 'dia_limites_facturas', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
