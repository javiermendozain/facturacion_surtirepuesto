...
CREATE VIEW factura_abono AS
 SELECT clientes.nit_cc,
    ...
    (((((to_char(facturar_ventas.fecha_hora, 'yyyy-Mon-DD'::text) || ' '::text) || 'Factura N°'::text) || facturar_ventas.n_factura) || ', Saldo: '::text) || to_char(facturar_ventas.saldo, 'LFM9,999,999.99'::text)) AS factura_saldo
   FROM clientes,
    facturar_ventas
...
INSERT INTO clientes (nit_cc, nombre_completo, direccion, tel_movil, email, fax, observacion, tel_fijo, sexo, idciudad) VALUES ('1064112459', 'WILMAN SAMIR PEREZ MOSCOTE', 'Transversal 1H 9-21 Barrio: 17 febrero', '3137137455', 'wilmanmoscote31@gmail.com', NULL, 'Tel Adicional: 313 5755576', NULL, 1, '418');
INSERT INTO clientes (nit_cc, nombre_completo, direccion, tel_movil, email, fax, observacion, tel_fijo, sexo, idciudad) VALUES ('0', 'VENTA DIARIA [POS]', 'N/A', '0000000000', NULL, NULL, NULL, NULL, 1, '418');
INSERT INTO clientes (nit_cc, nombre_completo, direccion, tel_movil, email, fax, observacion, tel_fijo, sexo, idciudad) VALUES ('1064118331', 'SANTIAGO MIGUEL VÁSQUEZ REGUILLO', 'Diagonal 9   #1G-50  Barrio: 17 Febrero', '3012032829', 'santiagomiguel_10@hotmail.com', NULL, NULL, NULL, 1, '418');
INSERT INTO clientes (nit_cc, nombre_completo, direccion, tel_movil, email, fax, observacion, tel_fijo, sexo, idciudad) VALUES ('1064117392', 'JAVIER MENDOZA CASTILLO', 'Diagonal 4 #1F-20, Barrio: 17 de febrero', '3005020032', 'jnegrazo@gmail.com', NULL, NULL, NULL, 1, '418');
INSERT INTO clientes (nit_cc, nombre_completo, direccion, tel_movil, email, fax, observacion, tel_fijo, sexo, idciudad) VALUES ('12524858', 'YORWIN ARIAS REALES', 'Diagonal 5 #1F-05, Barrio: 17 de febrero', '3164079851', 'tarayor@gmail.com', NULL, 'Abonara el Domingo: 80.000', NULL, 1, '418');
...
SELECT pg_catalog.setval('detalle_factura_venta_iddetalle_seq', 2101, true);
...
INSERT INTO facturar_ventas (clientes_nit_cc, idventa, fecha_hora, tipo_de_venta, abono, valor_total_pagar, n_factura, iva_total, descuento_total, saldo, sub_total, estado, user_id, printt, vendedor, utilidad_en_venta) VALUES ('12524858', 118, '2017-07-09 05:24:00-05', 2, 180000.00, 180000.00, '118', 11001.00, 0.00, 0.00, 168999.00, 2, 1064117392, NULL, NULL, 122100.00);
INSERT INTO facturar_ventas (clientes_nit_cc, idventa, fecha_hora, tipo_de_venta, abono, valor_total_pagar, n_factura, iva_total, descuento_total, saldo, sub_total, estado, user_id, printt, vendedor, utilidad_en_venta) VALUES ('1064118331', 119, '2017-07-09 05:29:00-05', 2, 130000.00, 130000.00, '119', 3477.00, 0.00, 0.00, 126523.00, 2, 1064117392, NULL, NULL, 111700.00);
INSERT INTO facturar_ventas (clientes_nit_cc, idventa, fecha_hora, tipo_de_venta, abono, valor_total_pagar, n_factura, iva_total, descuento_total, saldo, sub_total, estado, user_id, printt, vendedor, utilidad_en_venta) VALUES ('1064117392', 120, '2017-07-15 18:23:00-05', 1, 120000.00, 120000.00, '120', 3477.00, 0.00, 0.00, 116523.00, 2, 1064117392, NULL, NULL, 101700.00);
INSERT INTO facturar_ventas (clientes_nit_cc, idventa, fecha_hora, tipo_de_venta, abono, valor_total_pagar, n_factura, iva_total, descuento_total, saldo, sub_total, estado, user_id, printt, vendedor, utilidad_en_venta) VALUES ('1064112459', 134, '2017-07-25 18:52:00-05', 2, 100000.00, 260000.00, '134', 12540.00, 0.00, 160000.00, 247460.00, 1, 1064117392, NULL, NULL, 194000.00);
...
SELECT pg_catalog.setval('idventa', 144, true);
...
INSERT INTO productos (idproducto, nombre, stock_minimo, estado, precio_venta, precio_costo, stock, idcaracter, id_iva, idtipo, idunidad, idfactura_compra, iddescuentos, estado_stock, img) VALUES ('295', '<img src="img_productos/28258.jpg" width="20" height="20" /> Reloj de Lujo, cuero 2016 Femenino', 1, 1, 120000, 24500, 1, 87, 19.00, NULL, 4, 16, 0.00, NULL, 'img_productos/28258.jpg');
INSERT INTO productos (idproducto, nombre, stock_minimo, estado, precio_venta, precio_costo, stock, idcaracter, id_iva, idtipo, idunidad, idfactura_compra, iddescuentos, estado_stock, img) VALUES ('297', '<img src="img_productos/26514.jpg" width="20" height="20" />Reloj Lugo 2017 oro acero inoxidable unisex', 1, 1, 130000, 33000, 0, 84, 19.00, NULL, 4, 17, 0.00, NULL, 'img_productos/26514.jpg');
INSERT INTO productos (idproducto, nombre, stock_minimo, estado, precio_venta, precio_costo, stock, idcaracter, id_iva, idtipo, idunidad, idfactura_compra, iddescuentos, estado_stock, img) VALUES ('296', '<img src="img_productos/11099.jpg" width="20" height="20" />Reloj Lugo 2017 negro acero inoxidable unisex', 1, 1, 130000, 33000, 0, 84, 19.00, NULL, 4, 17, 0.00, NULL, 'img_productos/11099.jpg');
INSERT INTO productos (idproducto, nombre, stock_minimo, estado, precio_venta, precio_costo, stock, idcaracter, id_iva, idtipo, idunidad, idfactura_compra, iddescuentos, estado_stock, img) VALUES ('301', '<img src="img_productos/28355.jpg" width="20" height="20" />Reloj lujo casual automático', 1, 1, 135000, 21300, 1, 84, 19.00, NULL, 4, 19, 0.00, NULL, 'img_productos/28355.jpg');
INSERT INTO productos (idproducto, nombre, stock_minimo, estado, precio_venta, precio_costo, stock, idcaracter, id_iva, idtipo, idunidad, idfactura_compra, iddescuentos, estado_stock, img) VALUES ('303', '<img src="img_productos/2723.jpg" width="20" height="20" />Reloj Lugo 2017 negro acero inoxidable unisex', 1, 1, 130000, 40600, 5, 84, 19.00, NULL, 4, 21, 0.00, NULL, 'img_productos/2723.jpg');
INSERT INTO productos (idproducto, nombre, stock_minimo, estado, precio_venta, precio_costo, stock, idcaracter, id_iva, idtipo, idunidad, idfactura_compra, iddescuentos, estado_stock, img) VALUES ('302', '<img src="img_productos/22256.png" width="20" height="20" />Reloj Lujo 2017 Negro acero inoxidable unisex Calendario', 1, 1, 130000, 42700, 1, 83, 19.00, NULL, 4, 20, 0.00, NULL, 'img_productos/22256.png');
INSERT INTO productos (idproducto, nombre, stock_minimo, estado, precio_venta, precio_costo, stock, idcaracter, id_iva, idtipo, idunidad, idfactura_compra, iddescuentos, estado_stock, img) VALUES ('300', '<img src="img_productos/8523.jpg" width="20" height="20" />Reloj deportivo masculino acero inoxidable', 1, 1, 180000, 57900, 0, 83, 19.00, NULL, 4, 19, 0.00, NULL, 'img_productos/8523.jpg');
INSERT INTO productos (idproducto, nombre, stock_minimo, estado, precio_venta, precio_costo, stock, idcaracter, id_iva, idtipo, idunidad, idfactura_compra, iddescuentos, estado_stock, img) VALUES ('293', '<img src="img_productos/11399.jpg" width="20" height="20" />Reloj de Lujo  2017 Masculino', 1, 1, 130000, 18300, 0, 86, 19.00, NULL, 4, 15, 0.00, NULL, 'img_productos/11399.jpg');
INSERT INTO productos (idproducto, nombre, stock_minimo, estado, precio_venta, precio_costo, stock, idcaracter, id_iva, idtipo, idunidad, idfactura_compra, iddescuentos, estado_stock, img) VALUES ('294', '<img src="img_productos/23668.png" width="20" height="20" />Reloj de Lujo  2017 Masculino', 1, 1, 120000, 18300, 0, 86, 19.00, NULL, 4, 15, 0.00, NULL, 'img_productos/23668.png');
