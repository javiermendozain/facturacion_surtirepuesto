    ...
    class public_productosPage extends Page
    {
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'porcentaje_utilidad_vendedor', 'porcentaje_utilidad_vendedor', $this->RenderText('$ Utilidad Para Vendedor'))
            );
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetPlaceholder($this->RenderText('NO USE ( $  .  , )'));
            $main_editor->SetPrefix($this->RenderText('$'));
            $main_editor->SetSuffix($this->RenderText('.00'));
            ...
            $main_editor->setInlineStyles('Align: right;');
            $main_editor->SetPlaceholder($this->RenderText('USE . PARA FRACCIONES [99.99]'));
            $main_editor->SetSuffix($this->RenderText('%'));
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new NumberViewColumn('porcentaje_utilidad_vendedor', 'porcentaje_utilidad_vendedor', '$ Utilidad Para Vendedor', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(2);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('.');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new UploadFileToFolderColumn('Imagen', 'img', $editor, $this->dataset, false, false, 'img_productos/', '%random%.%original_file_extension%', $this->OnGetCustomUploadFilename, false);
            ...
            $editor->SetSuffix($this->RenderText('.oo'));
            ...
            $editor->setInlineStyles('Align: right;');
            $editor->SetPlaceholder($this->RenderText('USE . PARA FRACCIONES [99.99]'));
            ...
            $editor->SetPlaceholder($this->RenderText('USE . PARA FRACCIONES [99.99]'));
            $editor->SetSuffix($this->RenderText('%'));
            $editColumn = new CustomEditColumn('$ Utilidad Para Vendedor', 'porcentaje_utilidad_vendedor', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $validator = new NumberValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('NumberValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        $displayGroup = $layout->addGroup('Registrar Productos',12);
        
        $displayGroup->addRow()->addCol($columns['img'],4);
        $displayGroup->addRow()->addCol($columns['nombre'],4)->addCol($columns['stock'],4)->addCol($columns['porcentaje_utilidad_vendedor'],4);
        $displayGroup->addRow()->addCol($columns['stock_minimo'],4)->addCol($columns['precio_venta'],4)->addCol($columns['precio_costo'],4);
        $displayGroup->addRow()->addCol($columns['id_iva'],4)->addCol($columns['iddescuentos'],4)->addCol($columns['idcaracter'],4);
        $displayGroup->addRow()->addCol($columns['idunidad'],4)->addCol($columns['idfactura_compra'],4)->addCol($columns['estado'],4);
        }
        ...
        protected function CreateGrid()
        {
            ...
            $defaultSortedColumns[] = new SortColumn('stock', 'ASC');
        ...
        protected function setClientSideEvents(Grid $grid) {
            $grid->SetInsertClientFormLoadedScript($this->RenderText('editors[\'utilidad_para_vendedor\'].visible(false);
            
            if (!GetApplication()->IsLoggedInAsAdmin()) {
            //if(!GetApplication()->HasAdminGrantForCurrentUser()){
            editors[\'precio_costo\'].visible(false);
            }'));
            
            $grid->SetEditClientFormLoadedScript($this->RenderText('editors[\'utilidad_para_vendedor\'].visible(false);'));
        }
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_id_iva_descripcion_search', 'id_iva', 'descripcion', null, 20);
            ...
            $lookupDataset->setOrderByField('descpcion_descuento', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, '_iddescuentos_descpcion_descuento_search', 'iddescuentos', 'descpcion_descuento', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('marca', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, '_idcaracter_marca_search', 'idcaracter', 'marca', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('descripcion', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, '_idunidad_descripcion_search', 'idunidad', 'descripcion', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('num_factura', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, '_idfactura_compra_num_factura_search', 'idfactura_compra', 'num_factura', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            $lookupDataset = new TableDataset(
                PgConnectionFactory::getInstance(),
                GetConnectionOptions(),
            ...
            $lookupDataset->setOrderByField('descripcion', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_id_iva_descripcion_search', 'id_iva', 'descripcion', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('descpcion_descuento', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_iddescuentos_descpcion_descuento_search', 'iddescuentos', 'descpcion_descuento', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('marca', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_idcaracter_marca_search', 'idcaracter', 'marca', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('descripcion', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_idunidad_descripcion_search', 'idunidad', 'descripcion', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('num_factura', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_idfactura_compra_num_factura_search', 'idfactura_compra', 'num_factura', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        ...
        { 
            if($fieldName=='porcentaje_utilidad_vendedor'){
            $customText=$rowData['utilidad_para_vendedor'];
            $handled=true;
            }
            ...
            /*
            if($fieldName=='img'){
            $customText=' <img src="'.$rowData['img'].'" width="32" height="32" />';
            $handled=true;
            }*/
        ...
        protected function doBeforeInsertRecord($page, &$rowData, &$cancel, &$message, &$messageDisplayTime, $tableName)
        {
            ...
            $rowData['utilidad_para_vendedor']=($rowData['precio_venta']-$rowData['precio_costo'])*($rowData['porcentaje_utilidad_vendedor']/100);
            
            //$rowData['nombre']='<img src="'.$rowData['img'].'" width="20" height="20" />'.$rowData['nombre'].'';
        }
