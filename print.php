...
$pdf->AddPage();
	...
	//INICIALIZA
	// Logo
			$pdf->Image('img/logo_factura.png',7.8,8,10);
			//$this->Image('../appipuc/imagn.png',0,0,180);
	...
	$pdf->Cell(30,10,utf8_decode('    Surtirepuestos la Costa '),0,1,'');
	
	$pdf->SetY(12.5);
	$pdf->SetX(85);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(30,10,utf8_decode(' Regimen __________. '),0,1,'');
	
	$pdf->SetY(19);
	$pdf->SetX(8);
	$pdf->Cell(30,10,utf8_decode(' NIT: __________________'),0,1,'');
	
	$pdf->SetY(24);
	$pdf->SetX(8);
	$pdf->Cell(30,10,utf8_decode(' ____________________________________________'),0,1,'');
	
	$pdf->SetY(29);
	$pdf->SetX(8);
	$pdf->Cell(30,10,utf8_decode(' Tels: ___________________________________ '),0,1,'');
    ...
    $pdf->Cell(40,8,utf8_decode('Fecha y Hora: '.date_format($date, 'Y-m-d h:m:i a').''),0,0,'C');
	...
	$pdf->Cell(120,6,utf8_decode('Cliente: '.$nombre.''),0,0,'l');
  ...
  substr(productos.nombre,strpos(productos.nombre,'>')+1,31), 
...
WHERE 
  ...
  //  $pdf->ln();
	$pdf->SetX(135);
	$pdf->Cell(41,6,utf8_decode('Efectivo: '),1,0,'R');
...
//$pdf->Cell(41,6,utf8_decode(GetPageHeight()),1,0,'R');
	//Visualiza PDF
	//$pdf->Output();
